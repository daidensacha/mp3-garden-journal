...
class ContactForm(FlaskForm):
    firstname = StringField("First Name",  [validators.DataRequired("Please enter your first name."), validators.Length(min=5, max=20)])
    lastname = StringField("Last Name",  [validators.DataRequired("Please enter your last name."), validators.Length(min=5, max=20)])
